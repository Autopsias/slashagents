...
tools: Read, Write, Grep, Glob, mcp**playwright**browser_navigate, mcp**playwright**browser_snapshot, mcp**playwright**browser_click, mcp**playwright**browser_type, mcp**playwright**browser_take_screenshot, mcp**playwright**browser_wait_for, mcp**playwright**browser_console_messages, mcp**playwright**browser_network_requests, mcp**playwright**browser_evaluate, mcp**playwright**browser_fill_form, mcp**playwright**browser_tabs, mcp**playwright**browser_drag, mcp**playwright**browser_hover, mcp**playwright**browser_select_option, mcp**playwright**browser_press_key, mcp**playwright**browser_file_upload, mcp**playwright**browser_handle_dialog, mcp**playwright**browser_resize, mcp**playwright**browser_install
model: haiku
color: blue
---
...
try:
    mcp**playwright**browser_install()
    test_screenshot = mcp**playwright**browser_take_screenshot(filename=f"{evidence_dir}/browser_validation.png")
...
def discover_real_dom_elements():
    ...
    snapshot = mcp**playwright**browser_snapshot()
...
def execute_test_with_evidence(test_scenario):
    ...
    result = mcp**playwright**browser_take_screenshot(filename=before_screenshot)
    ...
    if test_scenario.action_type == "navigate":
        action_result = mcp**playwright**browser_navigate(url=test_scenario.url)
    elif test_scenario.action_type == "click":
        action_result = mcp**playwright**browser_click(
            element=test_scenario.element_description,
            ref=test_scenario.element_ref
        )
    elif test_scenario.action_type == "type":
        action_result = mcp**playwright**browser_type(
            element=test_scenario.element_description,
            ref=test_scenario.element_ref,
    ...
    result = mcp**playwright**browser_take_screenshot(filename=after_screenshot)
    ...
    if action_result and action_result.error:
        ...
        mcp**playwright**browser_take_screenshot(filename=error_screenshot)
    ...
    if screenshots_appear_identical(before_screenshot, after_screenshot):
        ...
        mcp**playwright**browser_take_screenshot(filename=warning_screenshot)
...
def test_chatgpt_real_implementation():
    ...
    navigate_result = mcp**playwright**browser_navigate(url="https://chatgpt.com")
    ...
    type_result = mcp**playwright**browser_type(
    ...
    if submit_button:
        submit_result = mcp**playwright**browser_click(
        ...
        mcp**playwright**browser_wait_for(time=10)
        response_screenshot = save_evidence_screenshot("ai_response_check")

        # Check if response appeared
        response_snapshot = mcp**playwright**browser_snapshot()
...
def save_evidence_screenshot(description):
    ...
    result = mcp**playwright**browser_take_screenshot(filename=filename)
...
def FAIL_WITH_EVIDENCE(message):
    ...
    console_logs = mcp**playwright**browser_console_messages()
...
def cleanup_browser_session():
    ...
    try:
        ...
        close_result = mcp**playwright**browser_close()
