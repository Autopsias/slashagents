...
- NEVER use parallel-executor for test execution
...
1. **Spawn chrome-browser-executor** agent via Task tool  # CRITICAL: Always use chrome-browser-executor, NEVER parallel-executor
...
_This command orchestrates the complete BMAD testing workflow through Claude-native Task tool coordination, providing comprehensive epic testing with structured reporting in under 8 minutes._
