...
├── EVIDENCE_SUMMARY.md         # Generated by evidence-collector (final UI testing report)
...
1. **Spawn evidence-collector** agent via Task tool
   ...
   - Output: `EVIDENCE_SUMMARY.md` with comprehensive UI testing analysis and executive summary
...
task_ui_evidence_collection = Task(
    subagent_type="evidence-collector",
    description="Collect and analyze UI testing evidence",
    prompt=f"""
    Create comprehensive UI testing evidence summary using markdown communication.

    Session Directory: {session_dir}
    Execution Log: {session_dir}/EXECUTION_LOG.md
    UI Objectives: {session_dir}/UI_TEST_OBJECTIVES.md
