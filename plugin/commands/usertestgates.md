...
if [[ -n "${CLAUDE_PLUGIN_ROOT}" && -f "${CLAUDE_PLUGIN_ROOT}/scripts/testgates_discovery.py" ]]; then
  TESTGATES_SCRIPT="${CLAUDE_PLUGIN_ROOT}/scripts/testgates_discovery.py"
elif [[ -f "$HOME/.claude/lib/testgates_discovery.py" ]]; then
  TESTGATES_SCRIPT="$HOME/.claude/lib/testgates_discovery.py"
elif [[ -f "$HOME/.claude/scripts/testgates_discovery.py" ]]; then
  TESTGATES_SCRIPT="$HOME/.claude/scripts/testgates_discovery.py"
else
  echo "❌ Test gates discovery script not found"
  echo "   Searched locations:"
  echo "   - \${CLAUDE_PLUGIN_ROOT}/scripts/testgates_discovery.py"
  echo "   - $HOME/.claude/lib/testgates_discovery.py"
  echo "   - $HOME/.claude/scripts/testgates_discovery.py"
  echo ""
